...
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateAreaSectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateBannerSectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateCaseStudySectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateClaritySectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateMatterSectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdatePrioritySectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateProcessSectionRequest;
use App\Http\Requests\Api\CMS\OurServicesPageCms\DigitalServices\UpdateServicesSectionRequest;
use App\Models\Cms;
use Exception;
...
class DigitalServicesCmsController extends Controller
{
    function getMainSectionsList(): JsonResponse
    {
        try {
            $data = Cms::where('page', 'digital-services')->select('id', 'slug', 'type', 'page')
    ...
    {
        try {
            if ($section->type == 'Banner Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
    ...
    {
        try {
            if ($section->type == 'Priority Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
    ...
    {
        try {
            if ($section->type == 'Matter Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
    ...
    {
        try {
            if ($section->type == 'Services Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
    ...
    function getAreaSection(Cms $section): JsonResponse
    {
        try {
            if ($section->type == 'Area Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
                    'message' => 'Area Section retrieved successfully',
                    'data' => $section->load(['metas', 'metas.cmsMetaValues'])
                ], 200);
            }
            return response()->json([
                'status' => false,
                'message' => 'Area Section not found'
            ], 404);
        } catch (Exception $e) {
            return response()->json([
                'status' => false,
    ...
    function updateAreaSection(UpdateAreaSectionRequest $request, Cms $section): JsonResponse
    {
        try {
            if ($section->type == 'Area Section' && $section->page == 'digital-services') {
                DB::beginTransaction();
                ...
                return response()->json([
                    'status' => true,
                    'message' => 'Area Section updated successfully',
                    'data' => $section->load(['metas', 'metas.cmsMetaValues'])
                ], 200);
            }
            return response()->json([
    ...
    function getProcessSection(Cms $section): JsonResponse
    {
        try {
            if ($section->type == 'Process Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
    ...
    function updateProcessSection(UpdateProcessSectionRequest $request, Cms $section): JsonResponse
    {
        try {
            if ($section->type == 'Process Section' && $section->page == 'digital-services') {
                DB::beginTransaction();
    ...
    {
        try {
            if ($section->type == 'Case Study Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
    ...
    {
        try {
            if ($section->type == 'Clearity Section'  && $section->page == 'digital-services') {
                return response()->json([
                    'status' => true,
