...
use App\Http\Requests\Api\CMS\PrivacyPolicyPageCms\UpdateBannerSectionRequest;
use App\Http\Requests\Api\CMS\PrivacyPolicyPageCms\UpdateContactSectionRequest;
use App\Http\Requests\Api\CMS\PrivacyPolicyPageCms\UpdateContentSectionRequest;
use App\Models\Cms;
use Exception;
...
class PrivacyPolicyPageCmsController extends Controller
{
    function getMainSectionsList(): JsonResponse
    {
        try {
            $data = Cms::where('page', 'privacy-policy')->select('id', 'slug', 'type', 'page')
    ...
    {
        try {
            if ($section->type == 'Banner Section'  && $section->page == 'privacy-policy') {
                return response()->json([
                    'status' => true,
    ...
    {
        try {
            if ($section->type == 'Content Section'  && $section->page == 'privacy-policy') {
                return response()->json([
                    'status' => true,
    ...
    {
        try {
            if ($section->type == 'Contact Section'  && $section->page == 'privacy-policy') {
                return response()->json([
                    'status' => true,
