...
namespace App\Http\Requests\Api\Cms\OurServicesPageCms\Strategy;
...
class UpdateMatterSectionRequest extends FormRequest
{
    ...
    function sanitizedMeta(): array
    {
        ...
        if ($this->hasFile('file_1')) {
            ...
            $destinationPath = public_path('images/our-services/strategy/matter-section');
            $file->move($destinationPath, $filename);

            // Full public URL
            $file1 = asset('images/our-services/strategy/matter-section/' . $filename);
        }
        if ($this->hasFile('file_2')) {
            ...
            // Full public URL
            $file2 = asset('images/our-services/strategy/matter-section/' . $filename);
        }
