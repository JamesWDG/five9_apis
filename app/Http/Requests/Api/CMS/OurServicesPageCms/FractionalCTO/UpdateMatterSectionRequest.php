...
namespace App\Http\Requests\Api\CMS\OurServicesPageCms\FractionalCTO;
...
class UpdateMatterSectionRequest extends FormRequest
{
    ...
    function sanitizedMeta(): array
    {
        ...
        if ($this->hasFile('file_1')) {
            ...
            $destinationPath = public_path('images/our-services/fractional-cto/matter-section');
            $file->move($destinationPath, $filename);

            // Full public URL
            $file1 = asset('images/our-services/fractional-cto/matter-section/' . $filename);
        }
        if ($this->hasFile('file_2')) {
            ...
            // Full public URL
            $file2 = asset('images/our-services/fractional-cto/matter-section/' . $filename);
        }
